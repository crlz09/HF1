...
public class MisPublicaciones extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private String urlsola="http://www.ksfactory.com.ve/cercanos.php?pub_user=&id=";
